 ...
 * Used for auth flows and loading states for a consistent experience.
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6">
      <div className="relative flex h-[min(28vw,144px)] w-[min(28vw,144px)] min-h-[80px] min-w-[80px] max-h-[160px] max-w-[160px] flex-shrink-0 overflow-hidden rounded-full">
        <div
          className="absolute left-1/2 top-[40%] z-0 h-[200%] w-[170%] min-h-[170%] min-w-[170%] -translate-x-1/2 -translate-y-1/2 animate-spin"
          style={{
            background:
