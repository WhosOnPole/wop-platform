...
export function GridDetailView({
  ...
  // Sync selectedIndex from scroll position (view mode) — keeps indicator bar in sync with natural swipe
  useEffect(() => {
      ...
      {showUnifiedHero && (
        <div className="flex flex-col min-h-screen relative">
          ...
          <div className="relative h-[40vh] lg:h-[60vh] shrink-0 z-10">
            ...
            {/* Single hero scroll container: native scroll for natural swipe (left=next, right=prev); indicator bar syncs via scroll listener */}
            <div
              ref={mobileScrollRef}
