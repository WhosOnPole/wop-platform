...
export function ComingSoonContent() {
  ...
  return (
    <div className="flex min-h-screen bg-foundation-black">
      {/* Left Side - Background Points of Interest */}
      <div className="hidden lg:flex lg:w-2/3 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <p className="text-xl text-gray-400 max-w-md">
            Your ultimate Formula 1 fan community
          </p>
        </div>
      </div>

      {/* Right Side - Coming Soon Panel */}
      <div className="w-full lg:w-1/3 flex items-center justify-center p-8 relative bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/images/backsplash.png)' }}>
        <div className="w-full max-w-md space-y-8 rounded-lg bg-white/75 backdrop-blur-sm p-8 shadow-lg">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Join thousands of F1 fans sharing their passion, creating grids, and competing for the top spot
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="mt-4 flex justify-center space-x-4">
              <a
                href="https://twitter.com/whosonpole"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 transition-colors hover:text-racing-orange"
                aria-label="Twitter"
              >
              ...
              <a
                href="https://instagram.com/whosonpole"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 transition-colors hover:text-racing-orange"
