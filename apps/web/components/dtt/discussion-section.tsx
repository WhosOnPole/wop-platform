...
export function DiscussionSection({
  ...
  const inputVerticalPadding = fixedInput ? 'py-4' : 'py-1.5'
  const textareaClasses = isDark
    ? `min-w-0 flex-1 resize-none text-sm text-white placeholder:text-white/50 focus:outline-none focus:ring-0 rounded-l-2xl rounded-r-none border border-r-0 border-white/10 bg-white/10 px-4 ${inputVerticalPadding}`
    : `min-w-0 flex-1 resize-none text-sm text-black placeholder:text-gray-500 focus:outline-none focus:ring-0 rounded-l-2xl rounded-r-none border border-r-0 border-gray-200 bg-gray-100 px-4 ${inputVerticalPadding}`
