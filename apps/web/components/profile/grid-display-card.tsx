...
export function GridDisplayCard({
  ...
  // Format name (last name for drivers, full name for teams/tracks)
        ...
        {firstItem && (
          <div className="w-1/2">
            <Link
              ...
              className="block h-full rounded-lg border border-gray-200 bg-gray-50 p-4 hover:bg-gray-100 transition-colors"
            >
              <div className="flex h-full flex-col">
                <div className="mb-2 text-6xl font-bold text-gray-400">1</div>
                <div className="flex-1">
                  {getItemImageUrl(firstItem) ? (
                    <Image
                      ...
                      width={120}
                      height={120}
                      className={`object-contain ${grid.type === 'team' ? 'brightness-0 invert' : ''}`}
                    />
                  ) : (
          ...
          {otherItems.map((item, index) => {
            ...
            return (
              <Link
                ...
                className="block rounded-lg border border-gray-200 bg-gray-50 p-2 hover:bg-gray-100 transition-colors"
              >
                <div className="flex flex-col items-center">
                  <div className="mb-1 text-xs font-bold text-gray-400">{rank}</div>
                  ...
                  <div className="mt-1 text-xs font-medium text-gray-900 text-center line-clamp-2">
                    {formatItemName(item)}
                  </div>
                </div>
              </Link>
