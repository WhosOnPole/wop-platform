  ...
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      <div className="max-w-4xl mx-auto prose prose-lg">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">1. OUR SERVICES</h2>
        <p className="mb-8">
        ...
        <h3 className="text-xl font-semibold mb-2">Your submissions</h3>
        <p className="mb-4">
          Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.
        </p>
        <p className="mb-2"><strong>Submissions:</strong> By directly sending us any question, comment, suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">5. USER GENERATED CONTRIBUTIONS</h2>
        <p className="mb-4">
          The Services does not offer users to submit or post content. We may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Services, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, "Contributions"). Contributions may be viewable by other users of the Services and through third-party websites. When you create or make available any Contributions, you thereby represent and warrant that:
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">6. CONTRIBUTION LICENSE</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">7. SERVICES MANAGEMENT</h2>
        <p className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">8. TERM AND TERMINATION</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">9. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">11. DISPUTE RESOLUTION</h2>
        ...
        <h3 className="text-xl font-semibold mb-2">Exceptions to Informal Negotiations and Arbitration</h3>
        <p className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">12. CORRECTIONS</h2>
        <p className="mb-8">
          There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">13. DISCLAIMER</h2>
        <p className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">14. LIMITATIONS OF LIABILITY</h2>
        <p className="mb-4">
          IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
        </p>
        <p className="mb-4">
          NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR __________.
        </p>
        <p className="mb-8">
          CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">15. INDEMNIFICATION</h2>
        <p className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">16. USER DATA</h2>
        <p className="mb-8">
          We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">18. MISCELLANEOUS</h2>
        <p className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">19. CONTACT US</h2>
        <p className="mb-8">
