...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Who\'s on Pole, LLC.',
}
...
export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      <p className="text-sm text-gray-500 text-center mb-12">Last updated __________</p>

      <div className="max-w-4xl mx-auto prose prose-lg">
        <p className="mb-4">
          This Privacy Notice for Who's On Pole, LLC. ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>Visit our website at <a href="http://www.whosonpole.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">http://www.whosonpole.org</a> or any website of ours that links to this Privacy Notice</li>
          <li>Download and use our mobile application (Who's On Pole) or any other application of ours that links to this Privacy Notice</li>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">SUMMARY OF KEY POINTS</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">1. WHAT INFORMATION DO WE COLLECT?</h2>
        ...
        <p className="mb-4">
          <strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by PayPal. You may find their privacy notice link(s) here: <a href="https://www.paypal.com/us/legalhub/paypal/privacy-full" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://www.paypal.com/us/legalhub/paypal/privacy-full</a>.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: <a href="http://www.whosonpole.org/cookies" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">http://www.whosonpole.org/cookies</a>.
        </p>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        <p className="mb-2"><strong>In Short:</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We process the personal information for the following purposes listed below. We may also process your information for other purposes only with your prior explicit consent.</p>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
        ...
        <p className="mb-2"><strong>If you are located in Canada, this section applies to you.</strong></p>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
        ...
        <p className="mb-8">
          Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://www.whosonpole.org/cookies" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">http://www.whosonpole.org/cookies</a>.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">9. DO WE COLLECT INFORMATION FROM MINORS?</h2>
        <p className="mb-2"><strong>In Short:</strong> We do not knowingly collect data from or market to children under 18 years of age or the equivalent age as specified by law in your jurisdiction.</p>
        <p className="mb-8">
          We do not knowingly collect, solicit data from, or market to children under 18 years of age or the equivalent age as specified by law in your jurisdiction, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or the equivalent age as specified by law in your jurisdiction or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age or the equivalent age as specified by law in your jurisdiction has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18 or the equivalent age as specified by law in your jurisdiction, please contact us at <a href="mailto:support@whosonpole.org" className="text-blue-600 hover:underline">support@whosonpole.org</a>.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        <p className="mb-2"><strong>In Short:</strong> Depending on your state of residence in the US or in some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.</p>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2">Withdrawing your consent:</h3>
        <p className="mb-4">
        ...
        <p className="mb-8">
          <strong><u>Cookies and similar technologies:</u></strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://www.whosonpole.org/cookies" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">http://www.whosonpole.org/cookies</a>.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">12. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        <p className="mb-2"><strong>In Short:</strong> If you are a resident of California, Colorado, Connecticut, Delaware, Florida, Indiana, Iowa, Kentucky, Maryland, Minnesota, Montana, Nebraska, New Hampshire, New Jersey, Oregon, Rhode Island, Tennessee, Texas, Utah, or Virginia, you may have the right to request access to and receive details about the personal information we maintain about you and how we have processed it, correct inaccuracies, get a copy of, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. More information is provided below.</p>
        <h3 className="text-xl font-semibold mb-2">Categories of Personal Information We Collect</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2">Sources of Personal Information</h3>
        <p className="mb-4">
          Learn more about the sources of personal information we collect in "WHAT INFORMATION DO WE COLLECT?"
        </p>
        <h3 className="text-xl font-semibold mb-2">How We Use and Share Personal Information</h3>
        <p className="mb-4">
        ...
        <p className="mb-2">Depending upon the state where you live, you may also have the following rights:</p>
        <ul className="list-disc list-inside mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>by visiting <a href="http://www.whosonpole.org/help" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">http://www.whosonpole.org/help</a></li>
          <li>by emailing us at <a href="mailto:hello@whosonpole.org" className="text-blue-600 hover:underline">hello@whosonpole.org</a></li>
          <li>or by referring to the contact details at the bottom of this document.</li>
        </ul>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">13. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        <p className="mb-2"><strong>In Short:</strong> You may have additional rights based on the country you reside in.</p>
        <h3 className="text-xl font-semibold mb-2">Australia and New Zealand</h3>
        <p className="mb-4">
        ...
        <p className="mb-2">If you do not wish to provide the personal information necessary to fulfill their applicable purpose, it may affect our ability to provide our services, in particular:</p>
        <ul className="list-disc list-inside mb-4">
        ...
        <p className="mb-8">
          <a href="https://inforegulator.org.za/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">The Information Regulator (South Africa)</a><br />
          General enquiries: <a href="mailto:enquiries@inforegulator.org.za" className="text-blue-600 hover:underline">enquiries@inforegulator.org.za</a><br />
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">14. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
        <p className="mb-8">
          If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) by email at <a href="mailto:delisa.wray@gmail.com" className="text-blue-600 hover:underline">delisa.wray@gmail.com</a>, or contact us by post at:<br />
          Who's On Pole, LLC.<br />
          Data Protection Officer
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-8">16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
        <p className="mb-8">
          Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please visit: <a href="http://www.whosonpole.org/help" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">http://www.whosonpole.org/help</a>.
        </p>
      </div>
    </div>
  )
