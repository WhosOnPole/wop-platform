...
DROP FUNCTION IF EXISTS get_driver_fan_growth(UUID);

-- Recreate function to get trending drivers with proper search path
...
-- Recreate function to get driver fan growth with proper search path
