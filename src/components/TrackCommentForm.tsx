...
import { useCreateTrackComment } from '@/hooks/useTrackComments';
...
interface TrackCommentFormProps {
  trackId: string;
  trackName: string;
}

export const TrackCommentForm = ({ trackId, trackName }: TrackCommentFormProps) => {
